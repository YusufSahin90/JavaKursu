...
public class Ex1 {
    ...
    // 1.Adım : person isimli bir calss yazınız: fields: name, surname, age; olsun.
    // 2. Adım : main de 2 tane bu sınıftan nesne olusturup deger atayıız.
    // 3. Adım : getBirthYear isminde Person a iat bir method yazınız, çalıştıgında kişinin dogum yılını versin.
    // 4. Adım :  getInitials isminde kişiniz adının ilk harfi, soyadının ilk harfi şeklinde (buyuk harf) veren methodu yazınız.
    ...
    //2.Yöntem iyi metod kullandık, fakat her nesne için böyle yazarsak oldukça karışır.
