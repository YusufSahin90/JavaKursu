...
public class JavaLocalTime {
    public static void main(String[] args) {
        ...
        // Tarih içermez sadece saat, dk, sn, içerir 9:00 am gibi
        ...
        DateTimeFormatter format1 = DateTimeFormatter.ofPattern("hh:mm:ss a");  // a: am, pm,  localizasyon turkçe oldugu için ÖÖ(ögleden önce), ÖS(ogleden sonra)
        System.out.println("time1.format(format1) = " + time1.format(format1));
        
        DateTimeFormatter format2 = DateTimeFormatter.ofPattern("HH:mm:ss");   // HH 24 lu saat sistemine göre
