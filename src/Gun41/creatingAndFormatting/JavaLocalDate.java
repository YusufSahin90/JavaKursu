...
public class JavaLocalDate {
    public static void main(String[] args) {
        ...
        // Sadece gun, ay, yıldan oluşan tarih tutar, saat, dk, sn tutmaz, dogum tarihi 27.01.2000
        ...
        // Sistemde kullanılabilir lokalleri aşagıdaki kod le aldık, norver için if e bagladık.
        ...
        System.out.println("FULL Date Norvec = " + date1.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.FULL).withLocale(localeNorvec)));
    }
}
