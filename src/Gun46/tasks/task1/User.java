...
public class User {
    ...
    // 6- eğer password 6 dan küçük olursa yeniden user ı girsin. passwordun
    ...
    public User(String username, String password) {
        ...
        // this.id = sayac++;    // sayacın o anki degeri atanır,  ++ lar sagda oldugu icin sonrasında degeri 1 artar.
    ...
    public void setId() {
        ...
        this.id = sayac++;  // sayacın o anki degeri atanır,  ++ lar sagda oldugu için sonrasında degeri 1 artar.
    }
